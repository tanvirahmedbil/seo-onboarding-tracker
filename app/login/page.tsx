...
export default function LoginPage() {
  const { signIn, user, allowed } = useAuth();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white border border-gray-200 rounded-xl p-10 w-full max-w-sm shadow-sm">
        <h1 className="text-xl font-semibold text-gray-900 mb-1">SEO Onboarding Tracker</h1>
        <p className="text-sm text-gray-400 mb-8">Internal agency tool</p>
